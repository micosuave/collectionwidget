...
collectionwidget widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-collectionwidget
...
```html
<script type="text/javascript" src="path/to/collectionwidget.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.collectionwidget']);
```
